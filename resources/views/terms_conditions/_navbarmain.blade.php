		...
		<div class="container container-fluid">
			<div class=" row">
				...
				<div class="  navbar-header">
					...
					<a class="navbar-brand-mat scroll-link" data-id="home" href="#home" class="scroll-link">
						<img width="50" src="https://s3-ap-southeast-1.amazonaws.com/cryptovationx/public/logos/Token3.png">
						<!-- <img width="50" src=""> -->
